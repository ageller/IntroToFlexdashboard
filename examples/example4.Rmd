...
<br/>
For the gauge plots, the color indicates how the selected car compares with the rest of the cars (lower third in pink, middle third in yellow and upper third in blue).  For the scatter plots, the selected car is highlighted with purple.
...
renderUI(
  HTML(
    kable(mtcars) %>%
      kable_styling() %>%
      row_spec(1, bold = T, color = "black", background = "lightgray")
  )
)
